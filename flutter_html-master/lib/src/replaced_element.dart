...
abstract class ReplacedElement extends StyledElement {
  ...
  ReplacedElement(
      ...
      Style? style,
      dom.Element? node,
      this.alignment = PlaceholderAlignment.aboveBaseline, double? height, String? data})
  ...
  switch (element.localName) {
    ...
    case "svg":
      return SvgContentElement(
        ...
        width: double.tryParse(element.attributes['width'] ?? ""),
        height: double.tryParse(element.attributes['height'] ?? ""), name: '',
      );
    case "ruby":
      return RubyElement(
        element: element,
    ...
    default:
      return EmptyContentElement(name: element.localName.toString());
  }
}
