...
double _height(Map<String, String> attributes) {
  // final double heightString =  as double;
  final double heightString = double.parse(attributes["height"]??"0");
  return heightString == null ? heightString : heightString;
}

double _width(Map<String, String> attributes) {
  // final double widthString = attributes["width"] as double;
  final double widthString = double.parse(attributes["width"]??"0");
  return widthString == null ? widthString : widthString;
}
