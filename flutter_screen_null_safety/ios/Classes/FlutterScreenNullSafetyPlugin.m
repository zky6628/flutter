#import "FlutterScreenNullSafetyPlugin.h"

@implementation FlutterScreenNullSafetyPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"flutter_screen_null_safety"
            binaryMessenger:[registrar messenger]];
  FlutterScreenNullSafetyPlugin* instance = [[FlutterScreenNullSafetyPlugin alloc] init];
